...
function(e) {
    ...
    var r = function() {
        ...
        return r.validateConfigurationOptions = function(r) {
            ...
            return e.Utilities.forEachProperty(t, (function(t, r) {
        ...
        function t(e, t) {
            if (this._env = e, this.options = r.mergeConfigurationOptions(t), this._createIgnoreDuplicateModulesMap(), this._createNodeModulesMap(), this._createSortedPathsRules(), "" === this.options.baseUrl) {
                ...
                if (this.options.nodeMain && this._env.isNode) {
                    n = this.options.nodeMain, o = Math.max(n.lastIndexOf("/"), n.lastIndexOf("\\"));
                    this.options.baseUrl = n.substring(0, o + 1)
                }
            }
        }
        ...
        o = function() {
            ...
            return t.prototype._init = function(e) {
                ...
                if (/^node\|/.test(n)) {
                    ...
                    this._readSourceAndCachedData(f, g, l, (function(e, n, d, a) {
                        if (e) i(e);
                        else {
                            var l;
                            l = n.charCodeAt(0) === t._BOM ? t._PREFIX + n.substring(1) + t._SUFFIX : t._PREFIX + n + t._SUFFIX, l = u(l, f);
                            var c = {
                                    filename: p,
                                    cachedData: d
                                },
                ...
                var r = this._crypto.createHash("md5").update(t, "utf8").update(e.seed, "utf8").digest("hex"),
                    n = this._path.basename(t).replace(/\.js$/, "");
                return this._path.join(e.path, n + "-" + r + ".code")
            }, t.prototype._handleCachedData = function(e, t, r, n, o) {
                var i = this;
                e.cachedDataRejected ? this._fs.unlink(r, (function(n) {
                    o.getRecorder().record(62, r), i._createAndWriteCachedData(e, t, r, o), n && o.getConfig().onError(n)
                ...
                var o = this,
                    ...
                    u = function() {
                        setTimeout((function() {
                            a || (a = o._crypto.createHash("md5").update(t, "utf8").digest());
                            var i = e.createCachedData();
                            0 === i.length || i.length === s || d >= 5 || (s = i.length, o._fs.writeFile(r, Buffer.concat([a, i]), (function(e) {
                                e && n.getConfig().onError(e), n.getRecorder().record(63, r), u()
                            })))
                        }), i * Math.pow(4, d++))
                    };
                u()
                ...
                if (t) {
                    ...
                    this._fs.readFile(e, {
                        ...
                        !e && n && n.length > 0 ? (s = n.slice(0, 16), i = n.slice(16), r.record(60, t)) : r.record(61, t), a()
                    }))
        ...
        return s.prototype.reset = function() {
            ...
            s.prototype.getGlobalAMDDefineFunc = function() {
                ...
                if (this._modules2[u]) this._config.isDuplicateMessageIgnoredFor(e) || console.warn("Duplicate definition of module '" + e + "'");
                    ...
                    this._modules2[u] = l,
                        this._config.isBuild() && (this._buildInfoDefineStack[u] = s, this._buildInfoDependencies[u] = (l.dependencies || []).map((function(e) {
                ...
                this._modules2[e] || (this._modules2[e] = new r(e, this._moduleIdProvider.getStrModuleId(e), [], (function() {}), (function() {}), null));
                for (var o = [], i = 0, s = this._moduleIdProvider.getMaxModuleId(); i < s; i++) o[i] = !1;
                var d = !1,
                    a = [];
                for (a.push(e), o[e] = !0; a.length > 0;) {
                    var u = a.shift(),
                        l = this._modules2[u];
                    l && (d = l.onDependencyError(n) || d);
...
function(e) {
    ...
    i.config = o, i.getConfig = function() {
    ...
    }, e.init = s, "function" == typeof e.global.define && e.global.define.amd || (r = new e.ModuleManager(t, e.createScriptLoader(t), n, i, e.Utilities.getHighPerformanceTimestamp()), void 0 !== e.global.require && "function" != typeof e.global.require && i.config(e.global.require), (define = function() {
        return n.apply(null, arguments)
    }).amd = n.amd, "undefined" == typeof doNotInitLoader && s())
}(AMDLoader || (AMDLoader = {}));
