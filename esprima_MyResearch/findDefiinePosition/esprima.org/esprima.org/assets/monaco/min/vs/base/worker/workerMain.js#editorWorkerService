...
(function() {
    ...
    function(e) {
        ...
        var n = function() {
            ...
            return n.validateConfigurationOptions = function(n) {
                ...
                return e.Utilities.forEachProperty(t, (function(t, n) {
            ...
            function t(e, t) {
                if (this._env = e, this.options = n.mergeConfigurationOptions(t), this._createIgnoreDuplicateModulesMap(), this._createNodeModulesMap(), this._createSortedPathsRules(), "" === this.options.baseUrl) {
                    ...
                    if (this.options.nodeMain && this._env.isNode) {
                        r = this.options.nodeMain, i = Math.max(r.lastIndexOf("/"), r.lastIndexOf("\\"));
                        this.options.baseUrl = r.substring(0, i + 1)
                    }
                }
            }
        ...
        var t = function() {
            ...
            n = function() {
                ...
                return e.prototype.attachListeners = function(e, t, n) {
                    ...
                    i.setAttribute("async", "async"), i.setAttribute("type", "text/javascript"), this.attachListeners(i, n, r), i.setAttribute("src", t);
            ...
            i = function() {
                ...
                return t.prototype._init = function(e) {
                    ...
                    if (n && !this._didPatchNodeRequire) {
                        ...
                        i.prototype._compile = function(e, s) {
                            ...
                            try {
                                ...
                                u = f.slice(0, 16), d.cachedData = f.slice(16), l.record(60, c)
                            } catch (e) {
                                l.record(61, c)
                            }
                            ...
                            return r._handleCachedData(h, a, c, !d.cachedData, t), r._verifyCachedData(h, a, c, u, t), _
                        }
                    }
                    ...
                    if (/^node\|/.test(r)) {
                        ...
                        this._readSourceAndCachedData(h, g, c, (function(e, r, u, a) {
                            if (e) o(e);
                                ...
                                var c;
                                c = r.charCodeAt(0) === t._BOM ? t._PREFIX + r.substring(1) + t._SUFFIX : t._PREFIX + r + t._SUFFIX, c = l(c, h);
                                var d = {
                                        filename: p,
                                        cachedData: u
                                    },
                    ...
                    var n = this._crypto.createHash("md5").update(t, "utf8").update(e.seed, "utf8").digest("hex"),
                        r = this._path.basename(t).replace(/\.js$/, "");
                    return this._path.join(e.path, r + "-" + n + ".code")
                }, t.prototype._handleCachedData = function(e, t, n, r, i) {
                    var o = this;
                    e.cachedDataRejected ? this._fs.unlink(n, (function(r) {
                        i.getRecorder().record(62, n), o._createAndWriteCachedData(e, t, n, i), r && i.getConfig().onError(r)
                    ...
                    var i = this,
                        ...
                        l = function() {
                            setTimeout((function() {
                                a || (a = i._crypto.createHash("md5").update(t, "utf8").digest());
                                var o = e.createCachedData();
                                0 === o.length || o.length === s || u >= 5 || (s = o.length, i._fs.writeFile(n, Buffer.concat([a, o]), (function(e) {
                                    e && r.getConfig().onError(e), r.getRecorder().record(63, n), l()
                                })))
                            }), o * Math.pow(4, u++))
                        };
                    l()
                    ...
                    if (t) {
                        ...
                        this._fs.readFile(e, {
                            ...
                            !e && r && r.length > 0 ? (s = r.slice(0, 16), o = r.slice(16), n.record(60, t)) : n.record(61, t), a()
                        }))
                    } else this._fs.readFile(e, {
                        encoding: "utf8"
                    }, r)
                    ...
                    r && (e.cachedDataRejected || setTimeout((function() {
                        ...
                        r.equals(e) || (i.getConfig().onError(new Error("FAILED TO VERIFY CACHED DATA, deleting stale '" + n + "' now, but a RESTART IS REQUIRED")), o._fs.unlink(n, (function(e) {
    ...
    function(e) {
        ...
        var n = function() {
            function t(e, t, n, r, i, o) {
                this.id = e, this.strId = t, this.dependencies = n, this._callback = r, this._errorback = i, this.moduleIdResolver = o, this.exports = {}, this.error = null, this.exportsPassedIn = !1, this.unresolvedDependenciesCount = this.dependencies.length, this._isComplete = !1
            }
        ...
        var s = function() {
            ...
            return s.prototype.reset = function() {
                ...
                s.prototype.getGlobalAMDDefineFunc = function() {
                    ...
                    var n = null;
                    this._config.isBuild() && (n = new Error("StackLocation").stack || null), this._currentAnnonymousDefineCall = {
                        stack: n,
                        dependencies: e,
                        callback: t
                    }
                    ...
                    if (this._modules2[l]) this._config.isDuplicateMessageIgnoredFor(e) || console.warn("Duplicate definition of module '" + e + "'");
                        ...
                        this._modules2[l] = c,
                            this._config.isBuild() && (this._buildInfoDefineStack[l] = s, this._buildInfoDependencies[l] = (c.dependencies || []).map((function(e) {
                    ...
                    this._modules2[e] || (this._modules2[e] = new n(e, this._moduleIdProvider.getStrModuleId(e), [], (function() {}), (function() {}), null));
                    for (var i = [], o = 0, s = this._moduleIdProvider.getMaxModuleId(); o < s; o++) i[o] = !1;
                    var u = !1,
                        a = [];
                    ...
                    if (!e.isComplete()) {
                        ...
                        if (h) {
                            ...
                            for (s = 0, u = h.length; s < u; s++) this._loadPluginDependency(e.exports, h[s])
                        }
                    }
                }, s
        }();
    ...
    function(t) {
        ...
        var o = function(e, t) {
            ...
            s = function() {
                if (1 === arguments.length) {
                    if (arguments[0] instanceof Object && !Array.isArray(arguments[0])) return void o(arguments[0]);
        ...
        s.config = o, s.getConfig = function() {
        ...
        }, t.init = u, "function" == typeof t.global.define && t.global.define.amd || (r = new t.ModuleManager(n, t.createScriptLoader(n), i, s, t.Utilities.getHighPerformanceTimestamp()), void 0 !== t.global.require && "function" != typeof t.global.require && s.config(t.global.require), (e = function() {
            return i.apply(null, arguments)
        }).amd = i.amd, "undefined" == typeof doNotInitLoader && u())
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            }, t.firstIndex = r, t.first = function(e, t, n) {
                void 0 === n && (n = void 0);
                var i = r(e, t);
                return i < 0 ? n : e[i]
        ...
        function n(e, t) {
            switch (void 0 === t && (t = 0), typeof e) {
                case "object":
                    return null === e ? r(349, t) : Array.isArray(e) ? (o = e, s = r(104579, s = t), o.reduce((function(e, t) {
                        return n(t, e)
                    }), s)) : function(e, t) {
                        return t = r(181387, t), Object.keys(e).sort().reduce((function(t, r) {
        ...
        var i = function() {
            ...
            return e.prototype.getElements = function() {
                for (var e = this.source, t = new Int32Array(e.length), n = 0, r = e.length; n < r; n++) t[n] = e.charCodeAt(n);
                return t
            }, e
        }();
        t.StringDiffSequence = i, t.stringDiff = function(e, t, n) {
            ...
            a = function() {
                ...
                return e._isStringArray = function(e) {
                        ...
                        if (e._isStringArray(n)) {
                            for (var i = new Int32Array(n.length), o = 0, s = n.length; o < s; o++) i[o] = r.stringHash(n[o], 0);
                            return [n, i, !0]
                        }
                        ...
                        if (!s[0]) {
                            var h = this.ComputeDiffRecursive(e, d, r, f, s),
                                p = [];
                            return p = s[0] ? [new n.DiffChange(d + 1, t - (d + 1) + 1, f + 1, i - (f + 1) + 1)] : this.ComputeDiffRecursive(d + 1, t, f + 1, i, s), this.ConcatenateChanges(h, p)
                        }
                        ...
                        do {
                            (P = N + e) === S || P < L && c[P - 1] < c[P + 1] ? (m = (f = c[P + 1]) - N - i, f < M && E.MarkNextChange(), M = f, E.AddModifiedElement(f + 1, m), N = P + 1 - e) : (m = (f = c[P - 1] + 1) - N - i, f < M && E.MarkNextChange(), M = f - 1, E.AddOriginalElement(f, m + 1), N = P - 1 - e), w >= 0 && (e = (c = this.m_forwardHistory[w])[0], S = 1, L = c.length - 1)
                        } while (--w >= -1);
                        if (b = E.getReverseChanges(), y[0]) {
                            ...
                            E = new u, S = s, L = a, N = p[0] - v[0] - l, M = 1073741824, w = _ ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
                            do {
                                var P;
                                (P = N + o) === S || P < L && d[P - 1] >= d[P + 1] ? (m = (f = d[P + 1] - 1) - N - l, f > M && E.MarkNextChange(), M = f + 1, E.AddOriginalElement(f + 1, m + 1), N = P + 1 - o) : (m = (f = d[P - 1]) - N - l, f > M && E.MarkNextChange(), M = f, E.AddModifiedElement(f + 1, m + 1), N = P - 1 - o), w >= 0 && (o = (d = this.m_reverseHistory[w])[0], S = 1, L = d.length - 1)
                            } while (--w >= -1);
                            C = E.getChanges()
                        }
                        ...
                        for (var L = 1; L <= m / 2 + 1; L++) {
                            ...
                            for (w = h; w <= p; w += 2) {
                                c = (l = w === h || w < p && _[w - 1] >= _[w + 1] ? _[w + 1] - 1 : _[w - 1]) - (w - b) - E;
                                for (A = l; l > e && c > r && this.ElementsAreEqual(l, c);) l--, c--;
                                if (_[w] = l, S && Math.abs(w - y) <= L && l <= v[w]) return o[0] = l, u[0] = c, A >= v[w] && L <= 1448 ? this.WALKTRACE(y, d, f, C, b, h, p, E, v, _, l, t, o, c, i, u, S, a) : null
                            }
                            if (L <= 1447) {
                    ...
                    e.prototype.PrettifyChanges = function(e) {
                        ...
                        if (this.ChangesOverlap(e[e.length - 1], t[0], n)) {
                            ...
                            return s.Copy(e, 0, r, 0, e.length - 1), r[e.length - 1] = n[0], s.Copy(t, 1, r, e.length, t.length - 1), r
                        }
                        r = new Array(e.length + t.length);
                        return s.Copy(e, 0, r, 0, e.length), s.Copy(t, 0, r, e.length, t.length), r
    ...
    var s, u, a = this && this.__extends || (s = function(e, t) {
    ...
    e(n[7], r([0, 1]), (function(e, t) {
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                function(e) {
                    ...
                    e.empty = function() {
                        ...
                        return void 0 === n && (n = 0), void 0 === r && (r = e.length), {
                            next: function() {
                                return n >= r ? t.FIN : {
                                    done: !1,
                                    value: e[n++]
                        ...
                        var n = [];
                        if (0 === t) return n;
                        for (var r = 0, i = e.next(); !i.done && (n.push(i.value), !(++r >= t)); i = e.next());
                        return n
                    }, e.concat = function() {
            ...
            t.ChainableIterator = r, t.getSequenceIterator = function(e) {
                return Array.isArray(e) ? n.fromArray(e) : e || n.empty()
            };
            var i = function() {
                function e(e, t, n, r) {
                    void 0 === t && (t = 0), void 0 === n && (n = e.length), void 0 === r && (r = t - 1), this.items = e, this.start = t, this.end = n, this.index = r
                }
            ...
            var o = function(e) {
                function t(t, n, r, i) {
                    return void 0 === n && (n = 0), void 0 === r && (r = t.length), void 0 === i && (i = n - 1), e.call(this, t, n, r, i) || this
                }
                return a(t, e), t.prototype.current = function() {
            ...
            var c = function(e, t, n, r, i, o) {
                this.ctrlKey = e, this.shiftKey = t, this.altKey = n, this.metaKey = r, this.keyLabel = i, this.keyAriaLabel = o
            };
            ...
            var u = function() {
                ...
                return e.prototype.dispose = function() {
                    this._isDisposed || (i(this), this._isDisposed = !0, this.clear())
                    ...
                    return i(e), this._isDisposed ? console.warn(new Error("Trying to add a disposable to a DisposableStore that has already been disposed of. The added object will be leaked!").stack) : this._toDispose.add(e), e
                }, e
            }();
            t.DisposableStore = u;
            var a = function() {
            ...
            var l = function() {
                ...
                return Object.defineProperty(e.prototype, "value", {
                    ...
                    set: function(e) {
                        this._isDisposed || e === this._value || (this._value && this._value.dispose(), e && i(e), this._value = e)
                    },
                    enumerable: !0,
                    configurable: !0
                }), e.prototype.clear = function() {
                    ...
                    this._isDisposed = !0, i(this), this._value && this._value.dispose(), this._value = void 0
                }, e
            }();
            ...
            var r = function() {
                ...
                i = function() {
                    ...
                    return Object.defineProperty(e.prototype, "size", {
                        ...
                        } else e.prev === r.Undefined && e.next === r.Undefined ? (this._first = r.Undefined, this._last = r.Undefined) : e.next === r.Undefined ? (this._last = this._last.prev, this._last.next = r.Undefined) : e.prev === r.Undefined && (this._first = this._first.next, this._first.prev = r.Undefined);
                        this._size -= 1
                    }, e.prototype.iterator = function() {
                        var e, t = this._first;
                        return {
                            next: function() {
                                return t === r.Undefined ? n.FIN : (e ? e.value = t.element : e = {
                                    done: !1,
                                    value: t.element
                                }, t = t.next, e)
                            }
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                function(e) {
                    ...
                    function a(e, t, n, r, i) {
                        ...
                        var s = void 0,
                            ...
                            l = new c({
                                ...
                                onFirstListenerAdd: function() {
                                    o = e((function(e) {
                                        a++, s = t(s, e), r && !u && (l.fire(s), s = void 0), clearTimeout(u), u = setTimeout((function() {
                                            var e = s;
                    ...
                    }, e.once = t, e.map = n, e.forEach = r, e.filter = o, e.signal = function(e) {
                        return e
                    }, e.any = function() {
                        for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
                        return function(t, n, r) {
                            return void 0 === n && (n = null), i.combinedDisposable.apply(void 0, e.map((function(e) {
                                return e((function(e) {
                                    return t.call(n, e)
                                }), null, r)
                            })))
                        }
                    }, e.reduce = s, e.snapshot = u, e.debounce = a, e.stopwatch = function(e) {
                        var r = (new Date).getTime();
                        return n(t(e), (function(e) {
                            return (new Date).getTime() - r
                        }))
                    }, e.latch = l, e.buffer = function(e, t, n) {
                    ...
                    var d = function() {
                        ...
                        return e.prototype.map = function(t) {
                            ...
                            return void 0 === n && (n = 100), void 0 === r && (r = !1), new e(a(this.event, t, n, r, i))
            ...
            var u = -1,
                        ...
                        if ("number" == typeof this.customThreshold && (n = this.customThreshold), !(n <= 0 || e < n)) {
                            ...
                            if (this._stacks.set(r, i + 1), this._warnCountdown -= 1, this._warnCountdown <= 0) {
                                ...
                                this._stacks.forEach((function(e, t) {
                                    (!o || s < e) && (o = t, s = e)
                                })), console.warn("[" + this.name + "] potential listener LEAK detected, having " + e + " listeners already. MOST frequent listener (" + s + "):"), console.warn(o)
                            }
                            return function() {
                ...
                c = function() {
                    function e(e) {
                        this._disposed = !1, this._options = e, this._leakageMon = u > 0 ? new l(this._options && this._options.leakWarningThreshold) : void 0
                    }
                    return Object.defineProperty(e.prototype, "event", {
                            get: function() {
                                ...
                                return this._event || (this._event = function(n, r, s) {
                                    ...
                                    return u && t._options && t._options.onFirstListenerDidAdd && t._options.onFirstListenerDidAdd(t),
                                        t._options && t._options.onListenerDidAdd && t._options.onListenerDidAdd(t, n, r), t._leakageMon && (a = t._leakageMon.check(t._listeners.size)), l = {
                                            dispose: function() {
                                                (a && a(), l.dispose = e._noop, t._disposed) || (c(), t._options && t._options.onLastListenerRemove && (t._listeners && !t._listeners.isEmpty() || t._options.onLastListenerRemove(t)))
                                            }
                                        }, s instanceof i.DisposableStore ? s.add(l) : Array.isArray(s) && s.push(l), l
                                }), this._event
                            },
                            enumerable: !0,
                            configurable: !0
                            ...
                            if (this._listeners) {
                                ...
                                for (var t = this._listeners.iterator(), r = t.next(); !r.done; r = t.next()) this._deliveryQueue.push([r.value, e]);
            ...
            var d = function(e) {
                ...
                return a(t, e), t.prototype.pause = function() {
                    this._isPaused++
                    ...
                    if (0 !== this._isPaused && 0 == --this._isPaused)
                        if (this._mergeFn) {
                            ...
                            for (; !this._isPaused && 0 !== this._eventQueue.size;) e.prototype.fire.call(this, this._eventQueue.shift())
            ...
            var f = function() {
                function e() {
                    var e = this;
                    this.hasListeners = !1, this.events = [], this.emitter = new c({
                        onFirstListenerAdd: function() {
                ...
                return Object.defineProperty(e.prototype, "event", {
                    ...
                    return i.toDisposable(r.once((function() {
            ...
            var p = function() {
                function e() {
                    var e = this;
                    this.listening = !1, this.inputEvent = s.None, this.inputEventListener = i.Disposable.None, this.emitter = new c({
                        onFirstListenerDidAdd: function() {
            ...
            var o = function() {
                ...
                s = function() {
                    ...
                    return Object.defineProperty(e.prototype, "token", {
                        ...
                        void 0 === e && (e = !1), e && this.cancel(), this._parentListener && this._parentListener.dispose(), this._token ? this._token instanceof o && this._token.dispose() : this._token = r.None
                    }, e
                }();
            ...
            if ("object" != typeof navigator || l) {
                if ("object" == typeof process) {
                    n = "win32" === process.platform, r = "darwin" === process.platform, i = "linux" === process.platform, "en", "en";
            ...
            function o(e, t) {
                ...
                var n = t.length,
                    r = e.length;
                if (0 === n || 0 === r) return e;
                for (var i = r, o = -1; - 1 !== (o = e.lastIndexOf(t, i - 1)) && o + n === i;) {
                    if (0 === o) return "";
                    i = o
                }
            ...
            t.format = function(e) {
            ...
            }, t.isLowerAsciiLetter = u, t.isUpperAsciiLetter = a, t.equalsIgnoreCase = function(e, t) {
                ...
                return r
            }, t.isHighSurrogate = d, t.isLowSurrogate = f, t.getNextCodePoint = h, t.nextCharLength = function(e, t) {
                var n = b.getInstance(),
                    r = t,
                    i = e.length,
                    o = h(e, i, t);
            ...
            }, t.isString = r, t.isObject = i, t.isNumber = function(e) {
                return (typeof e === n.number || e instanceof Number) && !isNaN(e)
            }, t.isBoolean = function(e) {
                return !0 === e || !1 === e
            }, t.isUndefined = o, t.isUndefinedOrNull = s, t.assertType = function(e, t) {
            ...
            t.isEmptyObject = function(e) {
                    ...
                    return !0
                }, t.isFunction = a, t.validateConstraints = function(e, t) {
                    for (var n = Math.min(e.length, t.length), r = 0; r < n; r++) l(e[r], t[r])
                },
                t.validateConstraint = l, t.getAllPropertyNames = c, t.getAllMethodNames = function(e) {
                ...
                d = function() {
                    function e(e, t, n, r, a, c) {
                        void 0 === c && (c = !1),
                            "object" == typeof e ? (this.scheme = e.scheme || u, this.authority = e.authority || u, this.path = e.path || u, this.query = e.query || u, this.fragment = e.fragment || u) : (this.scheme = function(e, t) {
                                return e || t ? e : "file"
                            }(e, c), this.authority = t || u, this.path = function(e, t) {
                                switch (e) {
                                    case "https":
                                    case "http":
                                    case "file":
                                ...
                                return t
                            }(this.scheme, n || u), this.query = r || u, this.fragment = a || u, function(e, t) {
                    ...
                    return e.isUri = function(t) {
                        ...
                        var t = e.scheme,
                            ...
                            i = e.query,
                            o = e.fragment;
                        return void 0 === t ? t = this.scheme : null === t && (t = u), void 0 === n ? n = this.authority : null === n && (n = u), void 0 === r ? r = this.path : null === r && (r = u), void 0 === i ? i = this.query : null === i && (i = u), void 0 === o ? o = this.fragment : null === o && (o = u), t === this.scheme && n === this.authority && r === this.path && i === this.query && o === this.fragment ? this : new h(t, n, r, i, o)
                        ...
                        var t = u;
                        if (n.isWindows && (e = e.replace(/\\/g, l)), e[0] === l && e[1] === l) {
                            var r = e.indexOf(l, 2); - 1 === r ? (t = e.substring(2), e = l) : (t = e.substring(2, r), e = e.substring(r) || l)
                        }
                        ...
                        if (t) {
                            ...
                            var n = new h(t);
                            return n._formatted = t.external, n._fsPath = t._sep === f ? t.fsPath : null, n
                        }
                        return t
                    }, e
                }();
            ...
            function g(e) {
                for (var t = void 0, n = 0; n < e.length; n++) {
                    var r = e.charCodeAt(n);
                    35 === r || 63 === r ? (void 0 === t && (t = e.substr(0, n)), t += p[r]) : void 0 !== t && (t += e[n])
                }
                return void 0 !== t ? t : e
            }
                ...
                c = function(e) {
                    function t(t, n, r) {
                        var i = e.call(this) || this,
                            u = null;
                        i._worker = i._register(t.create("vs/base/common/worker/simpleWorker", (function(e) {
                        ...
                        return i._lazyProxy = new Promise((function(e, t) {
                            u = t, i._onModuleLoaded.then((function(t) {
                    ...
                    return a(t, e), t.prototype.getProxyObject = function() {
            ...
            var d = function() {
                function e(e, t) {
                    var n = this;
                    this._requestHandlerFactory = t, this._requestHandler = null, this._protocol = new l({
                ...
                return e.prototype.onmessage = function(e) {
                    ...
                    return this._requestHandlerFactory ? (this._requestHandler = this._requestHandlerFactory(s),
                        Promise.resolve(o.getAllMethodNames(this._requestHandler))) : (t && (void 0 !== t.baseUrl && delete t.baseUrl, void 0 !== t.paths && void 0 !== t.paths.vs && delete t.paths.vs, t.catchError = !0, self.require.config(t)), new Promise((function(e, t) {
                        self.require([n], (function(n) {
                            i._requestHandler = n.create(s), i._requestHandler ? e(o.getAllMethodNames(i._requestHandler)) : t(new Error("No RequestHandler!"))
                        }), t)
                    })))
                }, e
            }();
            t.SimpleWorkerServer = d, t.create = function(e) {
                return new d(e, null)
            }
            ...
            var n = function() {
                ...
                return e.prototype.with = function(t, n) {
                    return void 0 === t && (t = this.lineNumber), void 0 === n && (n = this.column), t === this.lineNumber && n === this.column ? this : new e(t, n)
            ...
            var s = function() {
                    function e(e) {
                        for (var t = [], n = [], r = 0, i = e.length; r < i; r++) t[r] = d(e[r], 1), n[r] = f(e[r], 1);
                    ...
                    return e.prototype.getElements = function() {
                        ...
                        e.prototype.createCharSequence = function(e, t, n) {
                            for (var r = [], i = [], o = [], s = 0, a = t; a <= n; a++)
                                for (var l = this.lines[a], c = e ? this._startColumns[a] : 1, d = e ? this._endColumns[a] : l.length + 1, f = c; f < d; f++) r[s] = l.charCodeAt(f - 1), i[s] = a + 1, o[s] = f, s++;
                            return new u(r, i, o)
                        }, e
                }(),
                u = function() {
            ...
            var l = function() {
                    ...
                    return e.createFromDiffResult = function(t, n, r, s, u, l, c) {
                        ...
                        if (0 === n.originalLength ? (d = r.getStartLineNumber(n.originalStart) - 1, f = 0) : (d = r.getStartLineNumber(n.originalStart), f = r.getEndLineNumber(n.originalStart + n.originalLength - 1)), 0 === n.modifiedLength ? (h = s.getStartLineNumber(n.modifiedStart) - 1,
                                p = 0) : (h = s.getStartLineNumber(n.modifiedStart), p = s.getEndLineNumber(n.modifiedStart + n.modifiedLength - 1)), l && n.originalLength > 0 && n.originalLength < 20 && n.modifiedLength > 0 && n.modifiedLength < 20 && u()) {
                            var g = r.createCharSequence(t, n.originalStart, n.originalStart + n.originalLength - 1),
                                v = s.createCharSequence(t, n.modifiedStart, n.modifiedStart + n.modifiedLength - 1),
                                _ = o(g, v, u, !0).changes;
                            c && (_ = function(e) {
                                if (e.length <= 1) return e;
                                for (var t = [e[0]], n = t[0], r = 1, o = e.length; r < o; r++) {
                                    var s = e[r],
                                        u = s.originalStart - (n.originalStart + n.originalLength),
                                        a = s.modifiedStart - (n.modifiedStart + n.modifiedLength);
                                    Math.min(u, a) < i ? (n.originalLength = s.originalStart + s.originalLength - n.originalStart, n.modifiedLength = s.modifiedStart + s.modifiedLength - n.modifiedStart) : (t.push(s), n = s)
                                }
                                return t
                            }(_)), m = [];
                            for (var y = 0, b = _.length; y < b; y++) m.push(a.createFromDiffChange(_[y], g, v))
                        }
                ...
                c = function() {
                    ...
                    return e.prototype.computeDiff = function() {
                        ...
                        if (this.shouldIgnoreTrimWhitespace) {
                            for (var r = [], i = 0, s = t.length; i < s; i++) r.push(l.createFromDiffResult(this.shouldIgnoreTrimWhitespace, t[i], this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges));
                            return {
                                quitEarly: n,
                                changes: r
                            }
                            ...
                            for (var p = i + 1 < h ? t[i + 1] : null, m = p ? p.originalStart : this.originalLines.length, g = p ? p.modifiedStart : this.modifiedLines.length; a < m && c < g;) {
                                ...
                                if (v !== _) {
                                    for (var y = d(v, 1), b = d(_, 1); y > 1 && b > 1;) {
                                        ...
                                        y--, b--
                                    }(y > 1 || b > 1) && this._pushTrimWhitespaceCharChange(u, a + 1, 1, y, c + 1, 1, b);
                                    for (var C = f(v, 1), E = f(_, 1), S = v.length + 1, L = _.length + 1; C < S && E < L;) {
                                        if (v.charCodeAt(C - 1) !== v.charCodeAt(E - 1)) break;
                                        C++, E++
                                    }(C < S || E < L) && this._pushTrimWhitespaceCharChange(u, a + 1, C, S, c + 1, E, L)
                                }
                                a++, c++
                            }
                        ...
                        if (!this._mergeTrimWhitespaceCharChange(e, t, n, r, i, o, s)) {
                            var u = void 0;
                            this.shouldComputeCharChanges && (u = [new a(t, n, t, r, i, o, i, s)]), e.push(new l(t, t, i, i, u))
                        }
            ...
            var u = function() {
                ...
                return e._createLink = function(e, t, n, r, i) {
                    ...
                    for (var u = function() {
                            ...
                            return s
                        }(), a = [], l = 1, c = t.getLineCount(); l <= c; l++) {
                        for (var d = t.getLineContent(l), f = d.length, h = 0, p = 0, m = 0, g = 1, v = !1, _ = !1, y = !1; h < f;) {
                            var b = !1,
                                C = d.charCodeAt(h);
                            if (13 === g) {
                                var E = void 0;
                                ...
                                E = void 0;
                                91 === C ? (_ = !0, E = 0) : E = u.get(C), 1 === E ? b = !0 : g = 13
            ...
            var n = function() {
                ...
                return e.prototype.navigateValueSet = function(e, t, n, r, i) {
                    var o;
                    if (e && t && (o = this.doNavigateValueSet(t, i))) return {
                        range: e,
                        value: o
                    };
                    if (n && r && (o = this.doNavigateValueSet(r, i))) return {
                        range: n,
                        value: o
                    };
                    return null
            ...
            function o(e, t) {
                try {
                    ...
                    if (t && ("object" == typeof t || "function" == typeof t)) {
                        ...
                        if ("function" == typeof n) return void l((i = n, o = t, function() {
                            i.apply(o, arguments)
                        }), e)
                    }
        ...
        })), e(n[29], r([0, 1, 19, 9, 17, 12, 2, 5, 22, 23, 28, 33]), (function(e, t, n, r, i, o, s, u, a, l, c) {
            "use strict";
            Object.defineProperty(t, "__esModule", {
                value: !0
            });
    ...
    var l = this && this.__awaiter || function(e, t, n, r) {
    ...
    e(n[34], r([0, 1, 13, 6, 7, 4, 12, 2, 5, 24, 31, 25, 26, 27, 29, 10]), (function(e, t, n, r, i, o, s, u, d, f, h, p, m, g, v, _) {
            ...
            var y = function(e) {
                    ...
                    return a(t, e), Object.defineProperty(t.prototype, "uri", {
                            ...
                            var n = p.getWordAtText(e.column, p.ensureValidWordDefinition(t), this._lines[e.lineNumber - 1], 0);
                            return n ? new d.Range(e.lineNumber, n.startColumn, e.lineNumber, n.endColumn) : null
                            ...
                            var t, n, r = this,
                                ...
                                a = function() {
                                    if (s < u.length) {
                                        ...
                                        return s += 1, t ? t.value = l : t = {
                                            done: !1,
                                            value: l
                                        }, t
                                    }
                                    return o >= r._lines.length ? i.FIN : (n = r._lines[o], u = r._wordenize(n, e), s = 0, o += 1, a())
                                };
                            return {
                                next: a
                            }
                ...
                b = function() {
                    ...
                    return t.prototype.dispose = function() {
                        ...
                        this._models[e.url] = new y(s.URI.parse(e.url), e.lines, e.EOL, e.versionId)
                        ...
                        return l(this, void 0, void 0, (function() {
                            ...
                            return c(this, (function(c) {
                                return i = this._getModel(e), o = this._getModel(t),
                                    i && o ? (s = i.getLinesContent(), u = o.getLinesContent(), a = new f.DiffComputer(s, u, {
                                        shouldComputeCharChanges: !0,
                                        shouldPostProcessCharChanges: !0,
                                        shouldIgnoreTrimWhitespace: n,
                                        shouldMakePrettyDiff: !0,
                                        maxComputationTime: r
                                    }), l = a.computeDiff(), d = !(l.changes.length > 0) && this._modelsAreIdentical(i, o), [2, {
                        ...
                        return l(this, void 0, void 0, (function() {
                            ...
                            return c(this, (function(c) {
                                ...
                                for (s = [], u = void 0, i = n.mergeSort(i, (function(e, t) {
                                        return e.range && t.range ? d.Range.compareRangesUsingStarts(e.range, t.range) : (e.range ? 0 : 1) - (t.range ? 0 : 1)
                                    ...
                                    if (f = l[a], h = f.range, p = f.text, "number" == typeof(m = f.eol) && (u = m),
                                        ...
                                        if (Math.max(p.length, g.length) > t._diffLimit) s.push({
                                            range: h,
                                            text: p
                                        });
                                        else
                                            for (v = r.stringDiff(g, p, !1), _ = o.offsetAt(d.Range.lift(h).getStartPosition()), y = 0, b = v; y < b.length; y++) C = b[y], E = o.positionAt(_ + C.originalStart), S = o.positionAt(_ + C.originalStart + C.originalLength), L = {
                        ...
                        return l(this, void 0, void 0, (function() {
                            ...
                            return c(this, (function(n) {
                                return (t = this._getModel(e)) ? [2, m.computeLinks(t)] : [2, null]
                            }))
                        }))
                        ...
                        return l(this, void 0, void 0, (function() {
                            ...
                            return c(this, (function(c) {
                                ...
                                for (o = new RegExp(n, r), s = Object.create(null), u = t.startLineNumber; u < t.endLineNumber; u++)
                                    for (a = i.getLineWords(u, o), l = 0, d = a; l < d.length; l++) f = d[l], isNaN(Number(f.word)) && ((h = s[f.word]) || (h = [], s[f.word] = h), h.push({
                                        startLineNumber: u,
                        ...
                        return l(this, void 0, void 0, (function() {
                            ...
                            return c(this, (function(c) {
                                ...
                                }), u = o.getValueInRange(t), (a = o.getWordAtPosition({
                                    lineNumber: t.startLineNumber,
                                    column: t.startColumn
                                }, s)) ? (l = o.getValueInRange(a), [2, g.BasicInplaceReplace.INSTANCE.navigateValueSet(t, u, a, l, n)]) : [2, null]) : [2, null]
                            }))
                        }))
                        ...
                        return this._foreignModuleFactory ? (this._foreignModule = this._foreignModuleFactory(o, n), Promise.resolve(_.getAllMethodNames(this._foreignModule))) : new Promise((function(r, s) {
                            e([t], (function(e) {
                                i._foreignModule = e.create(o, n), r(_.getAllMethodNames(i._foreignModule))
                            }), s)
                        }))
            ...
            t.EditorSimpleWorker = b, t.create = function(e) {
                return new b(e, null)
            }, "function" == typeof importScripts && (o.globals.monaco = v.createMonacoBaseAPI())
        })),
        function() {
            ...
            self.onmessage = function(e) {
                var t;
                n ? (n = !1, t = e.data, require([t], (function(e) {
                    setTimeout((function() {
